...
<html>
  <head>
    <meta charset="UTF-8">
    <title>ATK SHOP - <?php require('get_title.php'); ?></title>
  ...
  <body class="skin-green">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="home.php" class="logo"><b>ATK </b>SHOP</a>
        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" role="navigation">
          <!-- Sidebar toggle button-->
          <a href="#sidebar" class="sidebar-toggle" data-target="#sidebar" data-toggle="offcanvas" role="button">
        ...
        <section class="sidebar" id="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="transaksi") { echo "active"; } ?>">
              <a href="index.php">
                <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>Transaksi</span> 
              </a>
            </li>
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="auditLog") { echo "active"; } ?>">
